...
insert into disabled (is_parent, is_center, hobby, kind_of_disabled, user_id) VALUES (true, false, '운동', '왼팔장애', '장애인1');
insert into disabled (is_parent, is_center, hobby, kind_of_disabled, user_id) VALUES (true, true, '음악', '지체장애', '장애인2');
insert into disabled (is_parent, is_center, hobby, kind_of_disabled, user_id) VALUES (false, true, '미술', '발달장애', '장애인3');
insert into disabled (is_parent, is_center, hobby, kind_of_disabled, user_id) VALUES (false, true, '운동', '왼발장애', '장애인4');
...
insert into program  (teacher_ID, category, title, content, count_max, count, date) values (1 ,'음악', '노래듣자', '노래들을 사람', 50, 0, '2023-12-31');
